...
//         std::make_pair("production", " Италия, Великобритания, США (Fox Searchlight Pictures,
//         Regency Enterprises, Taurus Film)"), std::make_pair("genre", " комедия, фэнтези"),
//         std::make_pair("director", " Майкл Хоффман"),
//         std::make_pair("actor", " Софи Марсо, Кевин Клайн, Мишель Пфайффер, Стэнли Туччи, Руперт
//         Эверетт, Калиста Флокхарт, Доминик Уэст, Кристиан Бэйл, Анна Фрил, Дэвид Стрэтэйрн,
//         Роджер Рис, Сэм Рокуэлл, Грегори Джбара, Билл Ирвин, Макс Райт и др."),
//         std::make_pair("description", " По мотивам одноимённой пьесы Шекспира.В чувственном и
//         прекрасном мире низких холмов и бесподобных кулинарных кушаний персонажи Шекспира
//         получают новое право на жизнь, исследуя свой мир на новомодном изобретении — велосипеде.
//         Пролетая по лесным дорогам на двух колёсах, дворяне, любовники и актёры Тосканы
//         оказываются во власти озорных духов, которые правят миром…"), std::make_pair("mpaa", " G
//         (нет возрастных ограничений)"), std::make_pair("duration", " 01:55:37"),
