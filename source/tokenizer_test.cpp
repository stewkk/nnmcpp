...
TEST(TokenizerTest, SimpleTokenize) {
  ...
  TokenStream expected_stream(
      {Token(TokenType::TITLE, "Сон в летнюю ночь / A Midsummer Night's Dream (1999)"),
       ...
       Token(TokenType::TEXT,
             " По мотивам одноимённой пьесы Шекспира.В чувственном и прекрасном мире низких холмов "
             "и бесподобных кулинарных кушаний персонажи Шекспира получают новое право на жизнь, "
             "исследуя свой мир на новомодном изобретении — велосипеде. Пролетая по лесным дорогам "
             "на двух колёсах, дворяне, любовники и актёры Тосканы оказываются во власти озорных "
             "духов, которые правят миром…"),
